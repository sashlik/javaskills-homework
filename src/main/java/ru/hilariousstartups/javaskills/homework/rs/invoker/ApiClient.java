package ru.hilariousstartups.javaskills.homework.rs.invoker;
...
import ru.hilariousstartups.javaskills.homework.rs.invoker.auth.Authentication;
import ru.hilariousstartups.javaskills.homework.rs.invoker.auth.HttpBasicAuth;
import ru.hilariousstartups.javaskills.homework.rs.invoker.auth.ApiKeyAuth;
import ru.hilariousstartups.javaskills.homework.rs.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-04-17T19:11:39.886977+03:00[Europe/Moscow]")@Component("ru.hilariousstartups.javaskills.homework.rs.invoker.ApiClient")
public class ApiClient {
    ...
    @Autowired
    public ApiClient(RestTemplate restTemplate, @Value("${rs.endpoint}") String endpoint) {
        basePath = endpoint + "/";
